...
import com.jiyouliang.monitor.ui.BaseFragment;
import com.jiyouliang.monitor.util.LogUtil;
import com.jiyouliang.monitor.util.os.CountDownThreadTimer;
import com.jiyouliang.monitor.view.widget.KeyboardContainerView;
import com.jiyouliang.monitor.view.widget.KeyboardInputView;
import com.jiyouliang.monitor.view.widget.LoadingDialog;
import com.jiyouliang.monitor.view.widget.TopTitleView;

/**
 * @author jiyouliang
 *
 * 短信验证码登录
 * 由于Activity包含多个Fragment,Fragment之间通信通过接口回调{@link OnFragmentInteractionListener}
